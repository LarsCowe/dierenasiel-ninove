...
const EPICS: Epic[] = [
  ...
  },
  {
    ...
    stories: [
      ...
      { id: "4.5", title: "DogID/CatID Overdracht (Automatische Taak)", status: "backlog" },
  ...
  },
  {
    ...
    status: "backlog",
    stories: [
      { id: "6.1", title: "Workflow Instellingen en Feature Toggles", status: "backlog" },
  ...
  },
  {
    ...
    status: "backlog",
    stories: [
      { id: "7.1", title: "Rapportage Framework en Dierenoverzicht", status: "backlog" },
