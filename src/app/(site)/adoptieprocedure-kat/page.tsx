...
export const metadata: Metadata = {
  title: "Adoptieprocedure katten",
  description:
    "Hoe verloopt een adoptie van een kat bij Dierenasiel Ninove? Lees hier de volledige procedure, voorwaarden en adoptieprijzen.",
};

const PRICING = [
  { age: "Jonger dan 6 maanden", price: "€200" },
  { age: "Tussen 1 en 10 jaar", price: "€180" },
  { age: "Ouder dan 10 jaar", price: "± €100" },
];

export default function AdoptieprocedureKatPage() {
  return (
        ...
        <AnimateOnScroll className="mb-12">
          ...
          <div className="space-y-4 text-text-light leading-relaxed">
            ...
            <p>
              ...
              gezin</strong>. Wees er zeker van dat iedereen overtuigd is om een
              kat te adopteren voor je met ons contact opneemt.
            </p>
          </div>
        </AnimateOnScroll>
          ...
          <div className="bg-warm rounded-2xl p-8 space-y-4 text-text-light leading-relaxed">
            ...
            <ul className="space-y-3">
              <li className="flex gap-3">
                ...
                <span>
                  Wij <strong>reserveren geen katten</strong> voor meerdere
              ...
              <li className="flex gap-3">
                ...
                <span>
                  ...
                  voor onze katten een thuis voor de rest van hun leven, waar er
              ...
              <li className="flex gap-3">
                ...
                <span>
                  ...
                  <strong>aanpassingsperiode van 3 maanden</strong>.
                </span>
              </li>
            </ul>
          </div>
        ...
        <AnimateOnScroll>
          <div className="bg-primary/5 border border-primary/15 rounded-2xl p-8 text-center">
            <h3 className="font-heading text-xl font-bold text-primary-dark mb-3">
              Interesse in een van onze katten?
            </h3>
